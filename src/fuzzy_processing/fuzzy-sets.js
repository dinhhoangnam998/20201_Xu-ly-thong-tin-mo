...
const distanceObstacle = [
  { name: DISTANCE_OBSTACLE_NEAR, muy: makeTrapezoid(0.05, 0.2) },
...
module.exports = { deviation, steering, lightStatus, distanceLight, distanceObstacle, speed };
